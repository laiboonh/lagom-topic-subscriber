...
lazy val `hello-world` = (project in file("."))
  .aggregate(`hello-world-api`, `hello-world-impl`,
    `hello-world-stream-api`, `hello-world-stream-impl`,
    `hello-world-topic-api`, `hello-world-topic-impl`
  )
...
lazy val `hello-world-topic-api` = (project in file("hello-world-topic-api"))
  .settings(
    libraryDependencies ++= Seq(
      lagomScaladslApi
    )
...
lazy val `hello-world-topic-impl` = (project in file("hello-world-topic-impl"))
  .enablePlugins(LagomScala)
  .settings(
    libraryDependencies ++= Seq(
      lagomScaladslPersistenceCassandra,
  ...
  .dependsOn(`hello-world-topic-api`)
